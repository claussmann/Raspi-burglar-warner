...
install: service_install notifier_install finish
	@ echo "\e[92mInstalled!\e[0m"
	@ echo "\e[92mYou will need to reboot now.\e[0m"

motion_install:
	@ apt-get update
	@ apt-get install motion
	@ echo "\e[92mInstalled motion\e[0m"

config: directories motion_config
	@ bash install_scripts/config.sh
	@ echo "\e[92mConfiguration complete\e[0m"
...
service_install: config sudoers_entry motion_install
	...
	@ echo "\e[92mInstalled remote service\e[0m"

notifier_install: config motion_install
	@ cp Notifier/* $(install_dir)/notifier/
	@ echo "\e[92mInstalled notifier service\e[0m"
...
directories: motion_install
	...
	@ echo "\e[92mCreated Directories\e[0m"
...
finish: service_install notifier_install
	...
	@ echo "\e[92mSet correct rights\e[0m"
